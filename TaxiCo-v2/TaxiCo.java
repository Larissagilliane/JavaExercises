...
public class TaxiCo
{
    ...
    /**
     * Calls a vehicle for a Passenger
     * @param Client Passenger who wants a vehicle
     * @return The vehicle that the passenger wants to go.
     */
    public Vehicle callVehicle(Passenger client)
    {
        ...
        for (Vehicle vehicle : vehicleFleet)
        {
            ...
            {
                if(vehicle.getDestination().equals(client.getDestination()))
                    return vehicle;
            }
